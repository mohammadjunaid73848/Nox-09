...
import { ArrowLeft, Moon, Sun, Save, Loader2, Monitor } from "lucide-react"
...
export default function SettingsPage() {
  ...
  const handleSave = async () => {
    if (!user) {
      setToastMessage("Please sign in to save instructions")
      setShowToast(true)
      return
    }
    ...
    try {
      ...
      setToastMessage("Instructions saved successfully")
      setShowToast(true)
    } catch (error: any) {
      console.error("Error saving instructions:", error)
      setToastMessage("Failed to save instructions")
      setShowToast(true)
    } finally {
      setIsSaving(false)
    }
        ...
        <div className="mx-auto max-w-2xl px-4 py-6 space-y-8">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Customize how Noxy AI looks</p>
            </div>
          ...
          <div className="space-y-4">
            <div>
              <h2 className="text-lg font-semibold mb-1">AI Memory</h2>
              <p className="text-sm text-muted-foreground">
                Add custom instructions that will be applied to all your conversations
              </p>
            </div>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    placeholder="Example: Always respond in a friendly tone. Keep answers concise. Use bullet points when listing items."
                ...
                {!user && (
                  <p className="text-sm text-center text-muted-foreground">
                    Please sign in to save custom instructions
                  </p>
                )}
              </div>
            )}
